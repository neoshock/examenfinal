...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnCapturar = findViewById<Button>(R.id.btn_capturar);
        btnCapturar.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View?) {
                Toast.makeText(view!!.context, "Codigo: " + code , Toast.LENGTH_LONG).show()
                createActivity(view)
            }
        })
    }
    ...
    fun createActivity(view: View?) {
        val intent = Intent(this, CountryResult::class.java).apply {
            putExtra("code", code)
        }
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        // method is called.
        val model = ModelFlags.newInstance(ctx)
